...
values (100, 0, '0', 'Aeson健身科技', 0, 'Aeson健身', '15888888888', 'aeson@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (101, 100, '0,100', '深圳总公司', 1, 'Aeson健身', '15888888888', 'aeson@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (102, 100, '0,100', '长沙分公司', 2, 'Aeson健身', '15888888888', 'aeson@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (103, 101, '0,100,101', '研发部门', 1, 'Aeson健身', '15888888888', 'aeson@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (104, 101, '0,100,101', '市场部门', 2, 'Aeson健身', '15888888888', 'aeson@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (105, 101, '0,100,101', '测试部门', 3, 'Aeson健身', '15888888888', 'aeson@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (106, 101, '0,100,101', '财务部门', 4, 'Aeson健身', '15888888888', 'aeson@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (107, 101, '0,100,101', '运维部门', 5, 'Aeson健身', '15888888888', 'aeson@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (108, 102, '0,100,102', '市场部门', 1, 'Aeson健身', '15888888888', 'aeson@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (109, 102, '0,100,102', '财务部门', 2, 'Aeson健身', '15888888888', 'aeson@qq.com', '0', '0', 'admin', sysdate(), '', null);
...
values (1, 103, 'admin', 'Aeson健身', '00', 'aeson@163.com', '15888888888', '1', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin',
        sysdate(), '', null, '管理员');
insert into sys_user
values (2, 105, 'aeson', 'Aeson健身', '00', 'aeson@qq.com', '15666666666', '1', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin',
        sysdate(), '', null, '测试员');
...
values ('3', '系统工具', '0', '3', 'tool', null, '', 1, 0, 'M', '0', '0', '', 'tool', 'admin', sysdate(), '', null,
        '系统工具目录');
insert into sys_menu
values ('4', 'Aeson健身官网', '0', '4', 'http://aeson.vip', null, '', 0, 0, 'M', '0', '0', '', 'guide', 'admin', sysdate(), '',
        null, 'Aeson健身官网地址');
-- 二级菜单
insert into sys_menu
...
values (1, '系统默认（无参）', 'DEFAULT', 'ryTask.ryNoParams', '0/10 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null,
        '');
insert into sys_job
values (2, '系统默认（有参）', 'DEFAULT', 'ryTask.ryParams(\'aeson\')', '0/15 * * * * ?', '3', '1', '1', 'admin', sysdate(), '',
        null, '');
insert into sys_job
values (3, '系统默认（多参）', 'DEFAULT', 'ryTask.ryMultipleParams(\'aeson\', true, 2000L, 316.50D, 100)', '0/20 * * * * ?', '3',
...
values ('1', '温馨提醒：2018-07-01 Aeson健身新版本发布啦', '2', '新版本内容', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice
values ('2', '维护通知：2018-07-01 Aeson健身系统凌晨维护', '1', '维护内容', '0', 'admin', sysdate(), '', null, '管理员');
